...
<head>
	...
	<title>MusicU - Reset Password Email</title>
</head>
						...
						<table border="0" cellpadding="0" cellspacing="0"> 
							...
							<tr>
								<td style="padding: 10px 0 20px 0; color: #565656; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: center;">
									Someone requested that the password for your</br> 
						MusicULive account be reset. 
								</td>
							</tr> 
							
							<tr>
								<td style="padding: 10px 0 20px 0; text-align: center;">
									<a href="<?php echo $slug; ?>" style="padding: 0px 60px; height: 40px; background: #f15929; color: #ffffff; font-family: Arial, sans-serif; font-size: 16px; line-height: 40px; text-decoration: none; display: inline-block; text-transform: uppercase; text-align: center; border-radius: 3px;">Reset my password</a>
								</td>
							</tr>
							<tr>
								<td style="padding: 10px 0 20px 0; color: #565656; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: center;">
