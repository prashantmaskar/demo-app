						...
						<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;"> 
							...
							<tr>
								<td style="padding: 10px 0 20px 0; color: #565656; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: center;">
									Moderation request received. Login to MusicULive for details.
								</td>
							</tr> 

							<tr>
								<td style="padding: 10px 0 20px 0; text-align: center;">
									<a href="<?php echo $admin_path; ?>" style="padding: 0px 60px; height: 40px; background: #f15929; color: #ffffff; font-family: Arial, sans-serif; font-size: 16px; line-height: 40px; text-decoration: none; display: inline-block; text-transform: uppercase; text-align: center; border-radius: 3px;">Go to <strong>MusicULive</strong></a>
								</td>
							</tr>
						</table>	
					</td>
